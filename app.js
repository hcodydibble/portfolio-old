...
$(document).ready(function(){
  $('#projects').click(function(){
    $('.replace').remove()
    $('.delete').remove()
    $('#stickHere').append('<a href="https://hcodydibble.github.io/bus-mall/">' + projectArray[0].name + '</a>')
    ...
    $('#stickHere').append('<a href="https://gabrielx52.github.io/tennis_anyone/">' + projectArray[1].name + '</a>')
